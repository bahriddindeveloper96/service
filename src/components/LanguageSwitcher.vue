<template>
  <div class="relative inline-block text-left">
    ...
    <div
      v-if="isOpen"
      class="absolute right-0 mt-2 origin-top-right bg-white border border-gray-300 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
    >
      <div class="py-1">
        <button
...
const currentLanguage = computed(() => {
  ...
  return lang ? lang.name : 'O\'zbekcha'
})
